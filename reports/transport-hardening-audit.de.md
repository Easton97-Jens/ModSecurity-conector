...
`modules/ModSecurity-test-Framework/ci/no_crs_baseline.py`, den No-CRS-Schemas
...
stammt aus `ci/prepare-runtime-components.py`, dem Framework-
`modules/ModSecurity-test-Framework/ci/prepare-nginx-build.sh` und
...
`ci/protocol_client.py` schreibt für einen verwalteten Probe immer diese
