...
| Basis-Revision | Ursprüngliche Änderungsbasis `9f23ae2c5fe908cef38f203be03f93fda75a8dd7`; synchronisierte Kandidatenbasis `603a7558e75a177222e22d8d0b87402dfad3f706` |
...
| `git diff --check origin/master...HEAD` | nach der normalen Synchronisierung bestanden; ist vor jeder Delivery-Aktion für den dann finalen exakten Kandidaten zwingend erneut auszuführen. |
...
- `git diff --check origin/master...HEAD` und `git status --short` sind nach jeder Kandidatenänderung einzelne Delivery-Gates. Sie müssen vor jedem Push oder Merge für den ausgewählten exakten Head erneut ausgeführt und beobachtet werden; dieser Record behauptet bis dahin keine Delivery.
