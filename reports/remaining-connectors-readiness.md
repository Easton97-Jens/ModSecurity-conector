...
`/var/tmp/ModSecurity-conector-verified/build/`. They are reproducible workspace
...
- `reports/envoy-connector-readiness.md`
- `reports/traefik-connector-readiness.md`
- `reports/lighttpd-connector-readiness.md`
