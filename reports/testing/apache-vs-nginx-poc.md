...
- NGINX-specific imported cases under `modules/ModSecurity-test-Framework/tests/cases/connector-specific/nginx/` currently
...
`docs/imports/common/shared-case-origin-map.md` and `framework test import plan`.
