...
- NGINX-specific imported cases under `modules/ModSecurity-test-Framework/tests/cases/connector-specific/nginx/imported/` currently
...
`modules/ModSecurity-test-Framework/docs/imports/import-analysis-apache.md` and `reports/testing/apache-poc.md`.
...
`tests/common/shared-case-origin-map.md` and `framework test import plan`.
