...
# Berichtsabhängigkeitsdiagramm

**Sprache:** [English](report-dependency-graph.generated.md) | Deutsch
...
| `runtime_build_cache` | `<verified-run-root>/component-cache/manifest.json`<br>`<verified-run-root>/component-cache/runtime-build-cache.json` | `reports/testing/generated/cache/runtime-build-cache.generated.json`<br>`reports/testing/generated/cache/runtime-build-cache.generated.md` | - |
| `runtime_component_cache` | `<verified-run-root>/component-cache/manifest.json`<br>`<verified-run-root>/component-cache/runtime-build-cache.json` | `reports/testing/generated/cache/runtime-component-cache.generated.json`<br>`reports/testing/generated/cache/runtime-component-cache.generated.md` | - |
| `runtime_cache_index` | `<verified-run-root>/component-cache/manifest.json`<br>`<verified-run-root>/component-cache/runtime-build-cache.json` | `reports/testing/generated/cache/runtime-cache-index.generated.json`<br>`reports/testing/generated/cache/runtime-cache-index.generated.md` | - |
...
- `<verified-run-root>/component-cache/manifest.json`
- `<verified-run-root>/component-cache/runtime-build-cache.json`
