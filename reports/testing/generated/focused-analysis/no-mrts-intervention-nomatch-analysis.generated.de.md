...
> Ziel erstellen: `generate-no-mrts-intervention-nomatch-analysis`
> Besitzer: `connector`
...
# No-MRTS-Intervention, No-Match-Analyse
...
- Einzelfälle: **8**
- Regel nicht geladen: **0**
- Regel geladen, keine Übereinstimmung: **32**
- Regel erfüllt, kein Eingriff: **0**
- Intervention erstellt, aber Connector hat nicht zurückgegeben 403: **0**
- Backend erreicht: **32**
...
- Passende native Fall-IDs: `-`
- Grund: Native MRTS-Berichte decken Upstream-MRTS-Zielfälle ab; Bei diesen 105-Zeilen handelt es sich um Framework-eigene Nicht-MRTS-Connector-Fälle.
- Nativer Apache-Status: `FAIL`
- Native NGINX Status: `FAIL`

## Sichere Subcluster-Entscheidung

- Ausgewählt: **nein**
- Cluster: `none`
- Anzahl: **0**
- Grund: Es wurde kein kleiner Safe harness/evidence Fix identifiziert. Die kleinste klare Gruppe ist Phase1_request_body_unavailable_or_empty_body, aber eine Änderung ihres Körpers würde die Testdefinition ändern.
- Aktion: nur Analyse; Keine Laufzeit-, Regel-, Erwartungsstatus- oder PASS/FAIL-Änderung
...
- Nur-Analyse-Bericht: Nein Erwarteter Status, Laufzeit-PASS/FAIL, Regel, Anforderung oder MRTS-Definition wurde geändert.
- Allein aufgrund dieser Nachweise wird keine connector/core-Codekorrektur empfohlen.
- In keiner Zeile wird ein generierter Störeingriff angezeigt, den ein Connector später verloren hat.
