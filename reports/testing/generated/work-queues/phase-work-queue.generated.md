...
|---|---|---:|---|
| `/root/git/ModSecurity-conector/.venv/bin/python /root/git/ModSecurity-conector/modules/ModSecurity-test-Framework/ci/generate-phase-work-queue.py --connector-root /root/git/ModSecurity-conector --framework-root /root/git/ModSecurity-conector/modules/ModSecurity-test-Framework --output-root /root/git/ModSecurity-conector --connector-work-queue /root/git/ModSecurity-conector/reports/testing/generated/work-queues/connector-work-queue.generated.json --phase-coverage /root/git/ModSecurity-conector/reports/testing/generated/coverage/phase-coverage.generated.md --full-runtime-matrix /root/git/ModSecurity-conector/reports/testing/generated/canonical/full-runtime-matrix.generated.json` | blocked | - | required generated input is blocked |
