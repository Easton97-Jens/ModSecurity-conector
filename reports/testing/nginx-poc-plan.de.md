...
- Quelle: `/root/conecter/ModSecurity-nginx`
...
Wenn `NGINX_RELEASE_TAG=latest`, `modules/ModSecurity-test-Framework/ci/prepare-nginx-build.sh` den tatsächlichen Wert auflöst
