...
`<verified-run-root>/build/`. Es handelt sich um
...
- `reports/archive/envoy-connector-readiness.de.md`
- `reports/archive/traefik-connector-readiness.de.md`
- `reports/archive/lighttpd-connector-readiness.de.md`
