...
> [Traefik-No-CRS-Snapshot](../evidence/traefik-no-crs-baseline.de.md) noch die
...
- Bauartefakt:
  `<verified-run-root>/build/traefik-connector/traefik-forwardauth`
- Laufzeitergebnis:
  `<verified-run-root>/build/traefik-connector/runtime-smoke/result.json`
- Laufzeitereignis:
  `<verified-run-root>/build/traefik-connector/runtime-smoke/logs/events.jsonl`
