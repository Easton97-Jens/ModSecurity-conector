...
- Parent repository path: `<repository-root>`.
...
- Framework `ci/lib/common.sh` pins CRS to `CRS_GIT_REF=v4.26.0`.
...
- Framework `ci/provisioning/prepare-haproxy-runtime.sh` can now prepare HAProxy `3.2.19`
