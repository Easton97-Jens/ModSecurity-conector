...
**Sprache:** [English](files-reviewed.md) | Deutsch
...
- `connectors/_template/tests/` (bestätigt abwesend)
...
- `connectors/nginx/tests/` (bestätigt abwesend)
...
- `connectors/apache/tests/` (bestätigt abwesend)
...
- `modules/ModSecurity-test-Framework/ci/runtime/run-apache-smoke.sh`
- `modules/ModSecurity-test-Framework/ci/runtime/run-haproxy-runtime-matrix.sh`
- `modules/ModSecurity-test-Framework/ci/reporting/write-haproxy-runtime-matrix.py`
- `modules/ModSecurity-test-Framework/ci/reporting/update-runtime-snapshot.py`
- `modules/ModSecurity-test-Framework/ci/reporting/generate-case-matrix.py`
- `modules/ModSecurity-test-Framework/ci/runtime/run-connector-smokes.sh`
...
- `reports/archive/template-verification-nginx-apache/README.md`
...
- `reports/archive/template-verification-nginx-apache/apache-template-alignment.md`
- `reports/archive/template-verification-nginx-apache/nginx-template-alignment.md`
- `reports/archive/template-verification-nginx-apache/nginx-evaluation.md`
- `reports/archive/template-verification-nginx-apache/apache-evaluation.md`
- `reports/archive/template-verification-nginx-apache/component-download-check.md`
- `reports/archive/template-verification-nginx-apache/runtime-test-run-src.md`
- `reports/archive/template-verification-nginx-apache/verified-runtime-run.md`
- `reports/archive/template-verification-nginx-apache/nginx-build-fail-analysis.md`
- `reports/archive/template-verification-nginx-apache/nginx-docroot-permission-analysis.md`
- `reports/archive/template-verification-nginx-apache/nginx-blocked-runtime-cases.md`
- `reports/archive/template-verification-nginx-apache/crs-action-status-401-analysis.md`
- `reports/archive/template-verification-nginx-apache/summary.md`
- `reports/archive/template-verification-nginx-apache/findings.md`
- `reports/archive/template-verification-nginx-apache/files-reviewed.md`
- `reports/archive/template-verification-nginx-apache/open-questions.md`

## Envoy Scaffold-Dateien
...
- `reports/archive/template-verification-nginx-apache/haproxy-template-alignment.md`

## HAProxy Build-Starter-Dateien
...
## HAProxy SPOA Agent-Starterdateien
...
## lighttpd Bridge-Starter-Dateien
...
Diese Dateien waren reviewed/updated als Bridge-Starter-Dokumentation und im Besitz des Repo
Nur Code metadata/probe/bridge. Es existiert kein lokaler `connectors/lighttpd/tests`-Ordner.
## Traefik Decision-Service Starter-Dateien
...
Gemeinsam genutzte Dateien, die von der Traefik-Entscheidungsservice-Starterdokumentation verwendet werden:
...
## Connector-Starter-Framework-Dateien
...
Die Ergebnisdateien sind lokale Nachweisartefakte und werden nicht festgeschrieben.

## Neue Connector Runtime-Smoke-Dateien
...
- `connectors/traefik/harness/run_traefik_smoke.sh`
- `modules/ModSecurity-test-Framework/ci/lib/common.sh`
- `modules/ModSecurity-test-Framework/ci/lib/connector-smoke-common.sh`
...
- `modules/ModSecurity-test-Framework/ci/runtime/run-haproxy-smoke.sh`
