...
- `ci/runtime/common/resolve-runtime-paths.py` zentralisiert validierte Evidence-, Build-,
...
- Framework: `modules/ModSecurity-test-Framework/tests/cases/no-crs-baseline/`
  und `ci/checks/catalog/no_crs_baseline.py`.
...
`ci/provisioning/components/prepare-runtime-components.py` verwendet Cache-Schema v2 und bildet
