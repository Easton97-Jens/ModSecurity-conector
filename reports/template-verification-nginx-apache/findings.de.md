...
- Pfad des übergeordneten Repositorys: `/root/git/ModSecurity-conector`.
...
- Framework `ci/common.sh` pinnt CRS an `CRS_GIT_REF=v4.26.0`.
...
- Framework `ci/prepare-haproxy-runtime.sh` kann jetzt HAProxy `3.2.19` vorbereiten
