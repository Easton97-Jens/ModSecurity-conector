# Entscheidungsdatensatz zur HAProxy-Integration

**Sprache:** [English](haproxy-integration-decision-record.md) | Deutsch
...
- `docs/connectors/future-connectors.md`: HAProxy erwartetes Modell „SPOE oder nativer Erweiterungspfad“.
- `docs/architecture/connector-adapter-interface.md`: Erforderliche Hooks und Boundary-Regeln.
- `Makefile`: keine HAProxy smoke/build Ziele.
...
### 1. SPOE / SPOA-Agent
- Belegt im Repo: als erwartetes Modell und TODO-Option erwähnt.
...
### 2. HAProxy-Filter
- Belegt im Repo: nativer Erweiterungspfad + Filteroption genannt.
...
- Risiko: hohe Kopplung an eine Serverinterna.
...
- Extern zu überprüfen: Protokolltreue, Latenz, Sicherheit, Fehlerpfade.
...
- Vollständige Intervention→HAProxy-Action-Mapping.
- Konkrete Build-Artefakte sind Option.
