...
.PHONY: check-codex-skills check-security-tools
...
check-codex-skills:
	$(PYTHON) ci/checks/documentation/check_codex_skills.py

check-security-tools:
	$(PYTHON) ci/checks/security/check_security_tools_manifest.py
