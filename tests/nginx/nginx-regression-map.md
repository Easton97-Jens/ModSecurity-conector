...
| `modsecurity.t` phase 1/2 block snippets | ARGS-based deny/status behavior | engine-core via NGINX runtime | yes | query args, phase:1/2, intervention | Redirect, custom status, phase:4, and nginx-tests harness logic remain connector-specific | `tests/common/cases/minimal/phase1_header_block.yaml`; `tests/common/cases/minimal/phase2_args_block.yaml` |
