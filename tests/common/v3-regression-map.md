...
| `test/test-cases/regression/auditlog.json` | ModSecurity_V3 | v3/master observed 3.0.15 | audit-log | Audit log behavior | partial | no | yes | maps | mapped-only | audit-log | Format normalization and serial/concurrent storage variants need more harness support |
