...
'''
    ...
    def test_expected_inventory_has_30_normal_jobs_and_one_special_job(self) -> None:
        self.assertEqual(len(CHECKER.EXPECTED_NORMAL_PYTHON_JOBS), 30)
        self.assertNotIn(
...
"""
    ...
    def test_json_cli_accepts_complete_contract(self) -> None:
        ...
        self.assertEqual(len(payload["detected_python_jobs"]), 33)
