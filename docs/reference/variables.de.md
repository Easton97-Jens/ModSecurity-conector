...
| <code>FULL_MATRIX_MAX_PARALLEL_JOBS</code>, <code>FULL_MATRIX_PORT_SPAN</code> | Full-Matrix-Runtime-Scheduler | nein | erkannte Online-CPU-Zahl (<code>nproc</code>, dann <code>getconf _NPROCESSORS_ONLN</code>, sonst <code>1</code>); <code>1000</code> | positive dezimale Ganzzahl | Begrenzt global geplante isolierte Runtime-Jobs und ihre Listener-Suchbereiche. Der Runner validiert zuerst jedes Apache-, NGINX- und HAProxy-Porttupel; bei fehlenden vorbereiteten Artefakten bleibt die Ausführung seriell. |
