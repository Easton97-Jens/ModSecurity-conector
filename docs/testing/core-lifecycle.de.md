...
# Sechs-Connector-Kern-Lifecycle

**Sprache:** [English](core-lifecycle.md) | Deutsch

## Geltungsbereich

Der ausgewählte aktuelle Kern umfasst HTTP/1.1 P1–P4, Safe-Post-Commit-P4-Semantik, First-Byte-vor-EOS-Evidence und keinen connector-eigenen vollständigen Response-Buffer für Apache, NGINX, HAProxy, Envoy, Traefik und lighttpd.
