...
**Language:** English | [Deutsch](local-development.de.md)

## Scope

Use a writable absolute build directory outside the checkout, for example `/srv/modsecurity-work/build`. This is an example value, not a repository default.
