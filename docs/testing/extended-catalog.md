...
**Language:** English | [Deutsch](extended-catalog.de.md)

## Scope

The extended catalog is separate from the selected core. `NOT EXECUTED`, `BLOCKED`, and `UNSUPPORTED` are evidence states, not PASS values and not hidden failures.
