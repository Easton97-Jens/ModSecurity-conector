...
Envoy external processing (`ext_proc`) with the repository bridge. Common receives only neutral mapped values; host APIs, allocation, and callback lifetime remain outside Common.
