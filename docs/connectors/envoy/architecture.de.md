...
Envoy External Processing (`ext_proc`) mit der Repository-Bridge. Common erhält nur neutral gemappte Werte; Host-APIs, Speicherallokation und Callback-Lebensdauer bleiben außerhalb von Common.
