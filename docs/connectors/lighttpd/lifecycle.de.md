...
Vor dem Response-Commit darf ein Host eine unterstützte Pre-Commit-Aktion anwenden. Nach dem Commit protokolliert Safe `log_only`; Safe behauptet keinen umgeschriebenen sichtbaren Status. Host-Patch, Kompression, optionale Protokollprofile und Strict-Enforcement bleiben durch die aktuelle Evidence ausdrücklich begrenzt.
