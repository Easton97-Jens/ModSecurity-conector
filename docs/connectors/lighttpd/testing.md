...
Run `make build-lighttpd`, `make check-config-lighttpd`, any available start/runtime smoke, and `make full-lifecycle-lighttpd` as separate levels. Build, configuration, and start are not rule-engine PASS.
