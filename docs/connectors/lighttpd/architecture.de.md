...
gepatchter nativer lighttpd-Host mit `mod_msconnector.so`. Common erhält nur neutral gemappte Werte; Host-APIs, Speicherallokation und Callback-Lebensdauer bleiben außerhalb von Common.
