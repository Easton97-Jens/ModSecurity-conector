...
native HAProxy HTX filter with the repository overlay. Common receives only neutral mapped values; host APIs, allocation, and callback lifetime remain outside Common.
