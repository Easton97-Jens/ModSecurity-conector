...
nativer HAProxy-HTX-Filter mit dem Repository-Overlay. Common erhält nur neutral gemappte Werte; Host-APIs, Speicherallokation und Callback-Lebensdauer bleiben außerhalb von Common.
