...
Vor dem Response-Commit darf ein Host eine unterstützte Pre-Commit-Aktion anwenden. Nach dem Commit protokolliert Safe `log_only`; Safe behauptet keinen umgeschriebenen sichtbaren Status. SPOE/SPOP bleibt ein Kompatibilitätspfad und wird nicht als ausgewählter Full-Lifecycle-Evidence-Pfad dargestellt.
