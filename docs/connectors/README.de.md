...
| lighttpd | <code>patched-native</code> | <code>patched-native-lighttpd</code> | [Guide](lighttpd.de.md) / [Quelle](../../connectors/lighttpd/README.de.md) | Gepatchte Native-Host-/Modulroute; ausgewählter HTTP/1.1-`mod_proxy`-P2-Traffic wird bis EOS/Allow vor Upstream-Erreichung gepuffert; P4 bleibt getrennt begrenzt |
