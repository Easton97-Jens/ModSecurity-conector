...
Führen Sie `make build-nginx`, `make check-config-nginx`, einen vorhandenen Start-/Runtime-Smoke und `make full-lifecycle-nginx` als getrennte Ebenen aus. Build, Config und Start sind kein Rule-Engine-PASS.
