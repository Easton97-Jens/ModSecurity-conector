...
Strict is a separate host capability. The selected evidence documents Safe post-commit semantics without claiming a rewritten response after commitment.
