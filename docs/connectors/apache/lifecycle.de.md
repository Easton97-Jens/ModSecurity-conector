...
Vor dem Response-Commit darf ein Host eine unterstützte Pre-Commit-Aktion anwenden. Nach dem Commit protokolliert Safe `log_only`; Safe behauptet keinen umgeschriebenen sichtbaren Status. Strict-Late-Verhalten ist eine host-spezifische Grenze; dieser Leitfaden promotet keine universelle Statusumschreibung nach dem Commit.
