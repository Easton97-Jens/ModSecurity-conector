...
Before response commitment, a host may take a supported pre-commit action. After commitment, Safe records `log_only`; Safe does not claim a rewritten visible status. Strict late behavior is a host-specific boundary; this guide does not promote a universal status rewrite after commitment.
