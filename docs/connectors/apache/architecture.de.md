...
Apache-httpd-Modul, gebaut über APXS. Common erhält nur neutral gemappte Werte; Host-APIs, Speicherallokation und Callback-Lebensdauer bleiben außerhalb von Common.
