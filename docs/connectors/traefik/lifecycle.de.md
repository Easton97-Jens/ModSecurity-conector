...
Vor dem Response-Commit darf ein Host eine unterstützte Pre-Commit-Aktion anwenden. Nach dem Commit protokolliert Safe `log_only`; Safe behauptet keinen umgeschriebenen sichtbaren Status. Safe ist der ausgewählte dokumentierte Kernmodus. Strict-Enforcement und `forwardAuth`-Kompatibilität sind getrennte Arbeit.
