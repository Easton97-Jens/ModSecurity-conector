...
**Language:** English | [Deutsch](artifact-layout.de.md)

## Scope

A canonical run may include `manifest.json`, `result.json`, `results.jsonl`, `events.jsonl`, `inventory.json`, first-byte records, transaction counts, lifecycle counters, and effective configuration metadata.
