...
**Language:** English | [Deutsch](provenance.de.md)

## Scope

A report records run ID, selected profile, generator, input records, and validation boundary. Relative repository links are portable; local machine paths are not provenance links.
