...
**Language:** English | [Deutsch](privacy.de.md)

## Scope

Canonical evidence is payload-free. Do not copy request bodies, response bodies, cookies, authorization headers, tokens, private keys, or raw secrets into events, logs, or reports.
