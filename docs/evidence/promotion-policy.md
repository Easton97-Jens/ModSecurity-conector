...
**Language:** English | [Deutsch](promotion-policy.de.md)

## Scope

Promotion requires the selected profile, attributable host evidence, valid normalization, and all required checks. Source shape or a successful command alone does not promote a capability.
