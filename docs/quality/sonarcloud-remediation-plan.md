...
| --- | --- | --- | --- | --- | --- | --- |
| `AZ4tAdJg9wBRmoDDtssa` | shell robustness | critical | `ci/probe-response-body-blocking.sh` | real | Add default `case` branch for generated path guard | fixed |
| `AZ4tAdJg9wBRmoDDtssb` | shell robustness | critical | `ci/probe-response-body-blocking.sh` | real | Add default `case` branch for repeat validation | fixed |
...
| `AZ4oLv83Rucw6R5zlwc_` | shell positional parameter | major | `ci/prepare-nginx-build.sh` | real | Assign `$1` to `target_path` before use | fixed |
| `AZ4oLv83Rucw6R5zlwdA` | shell positional parameter | major | `ci/prepare-nginx-build.sh` | real | Assign `$1` to `target_path` before use | fixed |
| `AZ4oLv83Rucw6R5zlwdB` | shell robustness | critical | `ci/prepare-nginx-build.sh` | real | Add default `case` branch for generated path guard | fixed |
| `AZ4oLv83Rucw6R5zlwdC` | shell robustness | critical | `ci/prepare-nginx-build.sh` | real | Add default `case` branch for refresh guard | fixed |
| `AZ4oLv83Rucw6R5zlwdD` | shell robustness | critical | `ci/prepare-nginx-build.sh` | real | Add default `case` branch for GitHub repo URL parsing | fixed |
...
| `AZ4n9oVN_9oVCvgyS3Qe` | shell positional parameter | major | `ci/prepare-apache-build.sh` | real | Assign `$1` to `target_path` before use | fixed |
| `AZ4n9oVN_9oVCvgyS3Qf` | shell positional parameter | major | `ci/prepare-apache-build.sh` | real | Assign `$1` to `target_path` before use | fixed |
| `AZ4n9oVN_9oVCvgyS3Qg` | shell robustness | critical | `ci/prepare-apache-build.sh` | real | Add default `case` branch for generated path guard | fixed |
| `AZ4n9oVN_9oVCvgyS3Qh` | shell robustness | critical | `ci/prepare-apache-build.sh` | real | Add default `case` branch for refresh guard | fixed |
| `AZ4n6KQK9eBhNcyBKSiZ` | shell robustness | critical | `ci/run-v3-api-smoke.sh` | real | Add default `case` branch for `BUILD_ROOT` guard | fixed |
| `AZ4n6KQK9eBhNcyBKSia` | shell robustness | critical | `ci/run-v3-api-smoke.sh` | real | Add default `case` branch for `BUILD_DIR` guard | fixed |
| `AZ4n6KOS9eBhNcyBKSiU` | shell positional parameter | major | `ci/build-v3-under-src.sh` | real | Assign `$1` to `target_path` before use | fixed |
| `AZ4n6KOS9eBhNcyBKSiV` | shell positional parameter | major | `ci/build-v3-under-src.sh` | real | Assign `$1` to `target_path` before use | fixed |
| `AZ4n6KOS9eBhNcyBKSiW` | shell robustness | critical | `ci/build-v3-under-src.sh` | real | Add default `case` branch for generated path guard | fixed |
