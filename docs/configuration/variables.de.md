...
| <code>VERIFIED_RUN_PARENT</code> | Runtime-Root | nein | <code>RUNNER_TEMP</code>, dann <code>TMPDIR</code>, dann <code>/var/tmp</code> | absolutes Verzeichnis | Elternpfad des invocation-eigenen Runtime-Baums |
...
| Root-Default | <code>RUNNER_TEMP</code>, dann <code>TMPDIR</code>, dann <code>/var/tmp</code> | <code>VERIFIED_RUN_ROOT/build</code> | <code>modules/ModSecurity-test-Framework</code> | <code>CACHE_ROOT/shared</code> |
...
- Die [Testing-Dokumentation](../testing/README.de.md) erläutert Status,
  Auswahl und Validierungsgrenzen.
- Die [Evidence-Dokumentation](../evidence/README.de.md) erläutert Artefakte
  und Promotion-Grenzen.
- Der [Dokumentationsstil-Leitfaden](../development/documentation-style-guide.de.md)
