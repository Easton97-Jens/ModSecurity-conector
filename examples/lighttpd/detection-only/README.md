# lighttpd DetectionOnly profile

**Language:** English | [Deutsch](README.de.md)

## Behavior

`detection-only/msconnector-runtime.conf` retains stock body modes `none` and selects DetectionOnly rules. DetectionOnly loads and evaluates engine rules and records
