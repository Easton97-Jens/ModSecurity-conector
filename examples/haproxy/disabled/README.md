# Haproxy disabled profile

**Language:** English | [Deutsch](README.de.md)

## Behavior

`disabled/haproxy-htx.cfg` omits `filter modsecurity-htx`; SPOE is not substituted. This is distinct from `SecRuleEngine Off`, which leaves an
