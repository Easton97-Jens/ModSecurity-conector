# Haproxy-deaktiviertes Profil

**Sprache:** [English](README.md) | Deutsch

## Verhalten

`disabled/haproxy-htx.cfg` lässt `filter modsecurity-htx` weg; SPOE wird nicht ersetzt. Dies unterscheidet sich von `SecRuleEngine Off`, das
