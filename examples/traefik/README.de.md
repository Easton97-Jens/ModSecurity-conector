...
| maxHeaderCount, maxHeaderBytes, maxRequestChunkBytes, maxRequestBodyBytes, maxResponseChunkBytes | Positive Plugin-Limits | Pflicht; dynamische Konfiguration; Middleware-Scope | 128, 65536, 32768, 1048576, 32768. `maxRequestBodyBytes` begrenzt den gesamten Request-Body; kleinere Werte lehnen mehr Input ab; Grenzen nicht entfernen. |
