...
remains intentionally nonfatal. The connector-owned Phase-4 body limit is a
separate Common reject boundary: an over-limit current buffer fails before the
original NGINX chain can forward an uninspected tail.
