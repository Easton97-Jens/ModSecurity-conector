...
- Request- und Response-Mapper liegen unter `connectors/envoy/src/envoy_modsecurity_mapper.*` und validieren die Common Mapper Contracts auf Structure-/Compile-Ebene.
