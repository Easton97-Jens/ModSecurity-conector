...
| `connectors/traefik/native_middleware/middleware.go` | repo-owned Go middleware source | selected by non-promoted full-lifecycle host probe | repository root license not documented | Bounded streaming wrapper whose production constructor requires the private UDS engine |
