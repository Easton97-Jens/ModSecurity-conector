...
#define traefik_modsecurity_config_init msconnector_generic_config_init
#define traefik_modsecurity_map_request msconnector_generic_map_request
#define traefik_modsecurity_map_response msconnector_generic_map_response
