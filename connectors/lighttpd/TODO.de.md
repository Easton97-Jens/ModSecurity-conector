...
`full-lifecycle-lighttpd-patched`, das einen passenden Framework-synchronisierten lighttpd-Core
...
- [x] Bereitstellung von Framework-synchronisiertem lighttpd-Quellcode/Binary verfügbar.
...
- [x] Framework-synchronisierter Source-Patch definiert begrenzte geliehene HTTP/1.x-
...
- [x] Dediziertes Patched-Host-Target kopiert, patcht, konfiguriert, baut,
      installiert, staged und ABI-lädt einen passenden Framework-synchronisierten Core plus Modul.
...
- [x] Framework-synchronisierter Source-Patch definiert einen begrenzten HTTP/1.1-
...
Das Stock-Modul besitzt keinen Response-Body-Hook. Das gepatchte Framework-synchronisierte Modul
