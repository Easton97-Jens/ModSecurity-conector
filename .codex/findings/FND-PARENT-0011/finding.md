# FND-PARENT-0011 — Envoy native capability remains non-promoted
...
| --- | --- |
| ID | `FND-PARENT-0011` |
| Title / Titel | `Envoy native capability remains non-promoted` |
...
Native ext_proc lifecycle controls passed, but capability_promotion is not_permitted and production_ready is false.
