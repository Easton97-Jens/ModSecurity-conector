# FND-PARENT-0007 — Traefik-Connector-Worker-Admission ist unbegrenzt
...
| --- | --- |
| ID | `FND-PARENT-0007` |
| Title / Titel | `Traefik-Connector-Worker-Admission ist unbegrenzt` |
...
Die statische Validierung fand bedingten Ressourcendruck durch unbegrenzte Connector-Level-Worker-Erzeugung bei anhaltendem UDS-Ingress.
...
Begrenzte aktive Kapazität reservieren, Überlast ablehnen und Saturation- sowie Normal-Traffic-Controls aufbewahren.
