# FND-PARENT-0010 — HAProxy-native Capability bleibt nicht promotet
...
| --- | --- |
| ID | `FND-PARENT-0010` |
| Title / Titel | `HAProxy-native Capability bleibt nicht promotet` |
...
Native HTX-Lifecycle-Controls bestanden, aber capability_promotion ist not_permitted und production_ready ist false.
