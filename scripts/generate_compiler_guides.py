...
CONNECTORS: tuple[dict[str, str], ...] = (
    ...
    },
    {
        ...
        "variables": "`ENVOY_BIN`, `EXT_PROC_CONFIG`, `EXT_PROC_RUNTIME_CONFIG`, `EXT_PROC_RUNTIME_ROOT`, `TLS_CERTIFICATE`, `TLS_PRIVATE_KEY`, `RULES_FILE`, `MSCONNECTOR_RULES_FILE`, and the opt-in `ENVOY_TRANSPORT_CANCEL_PROBE`.",
        "variables_de": "`ENVOY_BIN`, `EXT_PROC_CONFIG`, `EXT_PROC_RUNTIME_CONFIG`, `EXT_PROC_RUNTIME_ROOT`, `TLS_CERTIFICATE`, `TLS_PRIVATE_KEY`, `RULES_FILE`, `MSCONNECTOR_RULES_FILE` und das Opt-in `ENVOY_TRANSPORT_CANCEL_PROBE`.",
...
MANUAL_GUIDES: dict[str, dict[str, object]] = {
    ...
    "envoy": {
        ...
        "variables": (
            ...
            ("TLS_CERTIFICATE", "Private one-day loopback certificate path for the generated Envoy listener.", "Privater Pfad des eintägigen Loopback-Zertifikats für den erzeugten Envoy-Listener."),
            ("TLS_PRIVATE_KEY", "Private key path paired with TLS_CERTIFICATE; keep it outside the checkout.", "Private-Key-Pfad zu TLS_CERTIFICATE; außerhalb des Checkouts halten."),
    ...
    "lighttpd": {
        ...
        "host_source_alternative": (
            (
                ...
                "Diese fortgeschrittene Alternative für Vergleich oder reproduzierbare Buildlayouts beibehalten; sie baut weiterhin nur den gepatchten Host und verwendet dieselbe explizite Configure-/Bootstrap-Sperre.",
                (
