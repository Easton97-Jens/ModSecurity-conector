...
('"msconnector/event_jsonl.h"' in common_h and '"msconnector/event_jsonl.h"' not in access_c and '"msconnector/event_jsonl.h"' not in log_c, 'NGINX common header owns the event JSONL serialization dependency'),
