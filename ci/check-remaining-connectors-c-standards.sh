...
files="connectors/envoy/src/envoy_modsecurity_mapper.c connectors/traefik/src/traefik_modsecurity_mapper.c connectors/lighttpd/src/lighttpd_modsecurity_mapper.c common/src/config.c common/src/generic_mapper.c common/src/request_helpers.c common/src/response_helpers.c common/src/request_mapper_contract.c common/src/response_mapper_contract.c common/src/headers.c common/src/block_statuses.c common/src/http_status.c common/src/resource_limits.c common/src/error.c"
for f in $files; do
