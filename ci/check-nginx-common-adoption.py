...
('msconnector_headers_host' in mapper_c and 'msconnector_headers_parse_content_length' in all_nginx or 'msconnector_headers_host' in mapper_c, 'NGINX mapper uses Common header helpers'),
('msconnector_validate_content_type_token' in module_c, 'NGINX content-type validation uses Common parser/helper'),
