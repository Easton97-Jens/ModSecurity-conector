...
DEFAULT_SOURCE_ROOT="${DEFAULT_SOURCE_ROOT:-$BUILD_ROOT/sources}"
...
if [ -n "${REPO_ROOT:-}" ]; then
    DEFAULT_MODSECURITY_APACHE_SOURCE_DIR="${DEFAULT_MODSECURITY_APACHE_SOURCE_DIR:-$REPO_ROOT/connectors/apache}"
    DEFAULT_MODSECURITY_NGINX_SOURCE_DIR="${DEFAULT_MODSECURITY_NGINX_SOURCE_DIR:-$REPO_ROOT/connectors/nginx}"
else
